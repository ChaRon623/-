...
public class AnalyseList {
	...
	public AnalyseList(DefaultTableModel tbmodel_lex_result, DefaultTableModel tbmodel_gra_first,
			DefaultTableModel tbmodel_gra_follow, DefaultTableModel tbmodel_gra_predict) throws FileNotFoundException {
		productions = new ArrayList<Production>();
		terminals = new ArrayList<String>();
		nonterminals = new ArrayList<String>();
		firsts = new HashMap<String, ArrayList<String>>();
	...
	// 预测表生成
	public void preTableShow(DefaultTableModel tbmodel_gra_predict) throws FileNotFoundException {
		...
		//File file = new File("predict_table.txt");
		//RandomAccessFile randomfile2 = new RandomAccessFile(file, "rw");
		//line = line + "\n";
		// 写入文件
		//randomfile.writeBytes(line);
